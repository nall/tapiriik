...
def send_email(recipient_list, subject, html_message, plaintext_message=None):
	...
	email = EmailMultiAlternatives(subject=subject, body=plaintext_message, from_email="tapiriik <admin@sfrunners.club>", to=recipient_list, headers={"Reply-To": "admin@sfrunners.club"})
