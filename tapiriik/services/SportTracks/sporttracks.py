...
class SportTracksService(ServiceBase):
    ...
    def _getAuthHeaders(self, serviceRecord=None):
        ...
        if not token:
            ...
            params = {"grant_type": "refresh_token", "refresh_token": serviceRecord.Authorization["RefreshToken"], "client_id": SPORTTRACKS_CLIENT_ID, "client_secret": SPORTTRACKS_CLIENT_SECRET, "redirect_uri": "https://tapiriik.sfrunners.club/auth/return/sporttracks"}
